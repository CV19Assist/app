      ...
      <Paper className={classes.container}>
        ...
        <ol>
          ...
          <li>
            ...
            <ol>
              <li>
                Call the store in advance to place the order and pay with
                your credit card over the phone, letting them know someone else
                will be picking it up on your behalf.
              </li>
              <li>
                Provide your volunteer with cash before or after they
                complete the order. Make sure to leave the cash by the front
                door to avoid physical contact.
              </li>
              <li>
          ...
          <li>
            ...
            your receipt in the delivery bag and leave the bag at your doorstep,
            ringing your bell so you know it has arrived.
          </li>
        </ol>
